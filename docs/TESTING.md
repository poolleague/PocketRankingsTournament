...
The 53-test-case suite covers bracket validation, balanced seeding, propagated
...
and exact event/match assignment behavior.
...
must apply all four PostgreSQL migrations
